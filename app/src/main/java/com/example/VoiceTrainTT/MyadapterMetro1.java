...
public class MyadapterMetro1 extends FirebaseRecyclerAdapter<model, MyadapterMetro1.myviewholder>
{
    public MyadapterMetro1(@NonNull FirebaseRecyclerOptions<model> options) {
