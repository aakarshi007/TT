...
//        if (sourceStn.equalsIgnoreCase("Virar") && destStn.equalsIgnoreCase("Byculla")) {
//            FirebaseRecyclerOptions<model> options =
//                    new FirebaseRecyclerOptions.Builder<model>()
//                            .setQuery(FirebaseDatabase.getInstance().getReference().child("Locals").child("Central").orderByChild("Source").equalTo("Virar"), model.class)
//                            .build();
