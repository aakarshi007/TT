...
public class AddDataWestern extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_datawestern);
    ...
    private void processInsert()
    {
        ...
        FirebaseDatabase.getInstance().getReference().child("Locals").child("Western").push()
                .setValue(map)
