...
public class MyadapterHarbour1 extends FirebaseRecyclerAdapter<model, MyadapterHarbour1.myviewholder>
{
    public MyadapterHarbour1(@NonNull FirebaseRecyclerOptions<model> options) {
