...
public class AddDataWesternUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_datawesternup);
    ...
    private void processInsert()
    {
        ...
        FirebaseDatabase.getInstance().getReference().child("Locals").child("WesternUp").push()
                .setValue(map)
