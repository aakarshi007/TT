...
public class MyadapterWestern1 extends FirebaseRecyclerAdapter<model, MyadapterWestern1.myviewholder>
{
    public MyadapterWestern1(@NonNull FirebaseRecyclerOptions<model> options) {
            ...
            public void onClick(View view) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Locals").child("Western")
