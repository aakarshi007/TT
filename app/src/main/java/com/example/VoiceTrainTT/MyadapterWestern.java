...
public class MyadapterWestern extends FirebaseRecyclerAdapter<model, MyadapterWestern.myviewholder>
{
    public MyadapterWestern(@NonNull FirebaseRecyclerOptions<model> options) {
