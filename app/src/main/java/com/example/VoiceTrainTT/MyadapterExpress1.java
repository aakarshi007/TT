...
public class MyadapterExpress1 extends FirebaseRecyclerAdapter<model, MyadapterExpress1.myviewholder>
{
    public MyadapterExpress1(@NonNull FirebaseRecyclerOptions<model> options) {
            ...
            public void onClick(View view) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Express").child("ExpressUp")
